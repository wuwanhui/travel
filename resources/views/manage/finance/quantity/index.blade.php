                        ...
                        <fieldset>
                            <table class="table table-bordered table-hover  table-condensed">
                                ...
                                <tr style="text-align: center" class="text-center">
                                    ...
                                    <th style="width: 220px;"><a href="">用户</a></th>
                                ...
                                @foreach($lists as $item)
                                    <tr>
                                        ...
                                        <td style="text-align: center"><a
                                                    href="{{url('/manage/finance/quantity/edit/'.$item->id)}}">详情</a>
                                            @if($item->state!=0)
                                                |
                                                <a href="{{url('/manage/finance/quantity/delete/'.$item->id)}}">删除</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-md-4"><a
                                        href="{{url('/manage/finance/quantity/delete')}}"
