                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="name" type="text" class="form-control auto" name="name"
                                                   ...
                                                   value="{{ $directorie->name }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('idCard') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="idCard" type="text" class="form-control"
                                                   name="idCard"
                                                   style="width: auto;"
                                                   value="{{ $directorie->idCard }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('birthday') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="birthday" type="date" class="form-control" name="birthday"
                                                   style="width: auto;"
                                                   value="{{ $directorie->birthday }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="mobile" type="tel" class="form-control" name="mobile"
                                                   placeholder="必填"
                                                   style="width: auto;"
                                                   value="{{ $directorie->mobile }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('tel') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="tel" type="tel" class="form-control" name="tel"
                                                   placeholder="电话"
                                                   style="width: auto;"
                                                   value="{{ $directorie->tel }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="fax" type="fax" class="form-control" name="fax"
                                                   placeholder="传真号码"
                                                   style="width: auto;"
                                                   value="{{ $directorie->fax }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="email" type="email" class="form-control" name="email"
                                                   style="width: 300px;"
                                                   value="{{ $directorie->email }}" autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('addres') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <input id="addres" type="text" class="form-control" name="addres"
                                                   value="{{ $directorie->addres}}" autofocus>
